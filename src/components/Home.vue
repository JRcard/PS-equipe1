  ...
  <div class="bg-linear-to-r from-principale to-secondaire pb-30 pt-26 px-4">
    <div class="mx-auto">
      <div class="mx-auto max-w-4xl text-center">
        ...
        <p class="mt-2 text-5xl font-semibold tracking-tight text-balance text-white sm:text-6xl">Tout ce dont
          vous avez besoin pour gérer vos finances</p>
      </div>
      <p class="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-200 sm:text-xl/8">
        Stratos fournit tous les outils nécessaires pour prendre le contrôle de votre argent et atteindre vos
      ...
      <div class="grid lg:grid-cols-3 md:grid-cols-2 mx-auto">
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Créez des budgets flexibles
            qui s'adaptent à votre mode de vie, facilitant le suivi de vos objectifs.</p>
        </div>
        ...
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Ne manquez plus jamais une
            facture grâce aux paiements programmés et aux rappels intelligents pour les dépenses à venir.</p>
        </div>
        ...
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Comprenez vos revenus et
            dépenses grâce à des rapports visuels et des analyses prédictives.</p>
        </div>
        ...
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Connectez-vous en toute
            sécurité à plus de 15 000 banques dans le monde pour une synchronisation automatique des
            transactions et des mises à jour de solde en temps réel.</p>
        </div>
        ...
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-600 text-md leading-relaxed">Connectez vos données à
            Excel, aux assistants IA ou créez des intégrations personnalisées avec MCP et l'API REST.</p>
        </div>
      </div>
    </div>
  </div>
