<template>
				...
				<div class="max-w-2xl py-32 sm:py-48 lg:py-56">
					...
					<div>
						...
						<div v-if="!userConnecte" class="mt-10 flex items-center gap-x-6">
							...
							<RouterLink to="inscription" class="text-md font-semibold text-white hover:text-secondaire">
								S'inscrire
	...
	<div class="bg-linear-to-r from-principale to-secondaire pb-30 pt-26 px-4">
		<div class="mx-auto">
			<div class="mx-auto max-w-4xl text-center">
				<h2 class="text-md text-base/7 font-semibold text-white">Nos outils</h2>
				<p class="mt-2 text-5xl font-semibold tracking-tight text-balance text-white sm:text-6xl">Tout ce dont vous avez besoin pour gérer vos finances</p>
			</div>
			<p class="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-200 sm:text-xl/8">Stratos fournit tous les outils nécessaires pour prendre le contrôle de votre argent et atteindre vos objectifs financiers.</p>
			<div class="grid lg:grid-cols-3 md:grid-cols-2 mx-auto">
				<div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-principale hover:shadow-xl transition duration-300">
				...
				<div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-principale hover:shadow-xl transition duration-300">
					...
					<h3 class="text-lg font-semibold mb-3">Suivi des dépenses</h3>
					<p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Catégorisez et suivez automatiquement vos dépenses avec des analyses détaillées et des tendances de dépenses.</p>
				</div>
				...
				<div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-principale hover:shadow-xl transition duration-300">
					...
					<h3 class="text-lg font-semibold mb-3">Synchronisation bancaire</h3>
					<p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Connectez-vous en toute sécurité à plus de 15 000 banques dans le monde pour une synchronisation automatique des transactions et des mises à jour de solde en temps réel.</p>
				</div>

				<div class="rounded-xl group p-8 text-center hover:bg-white/80 text-white hover:text-principale hover:shadow-xl transition duration-300">
					<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 mb-6 inline-block" viewBox="0 0 682.667 682.667">
						<defs>
							<clipPath id="a" clipPathUnits="userSpaceOnUse">
								<path d="M0 512h512V0H0Z" data-original="#000000" />
					...
					<p class="text-gray-200 group-hover:text-gray-600 text-md leading-relaxed">Connectez vos données à Excel, aux assistants IA ou créez des intégrations personnalisées avec MCP et l'API REST.</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="mx-auto pt-14 max-w-4xl text-center">
		...
		<p class="mt-2 text-5xl font-semibold tracking-tight text-balance text-white sm:text-6xl">Choisissez le plan adapté à vos ambitions</p>
	</div>
	<p class="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">Optez pour une solution transparente, conçue pour vous aider à maîtriser votre budget, optimiser vos investissements et atteindre vos objectifs financiers.</p>

	<div class="isolate mx-auto my-24 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3 sm:mt-20">
		<!-- plan découverte -->
		<div class="rounded-xl p-8 ring-1 ring-white/10 xl:p-10 hover:bg-white/5 transition-colors">
			<h3 id="tier-free" class="text-base/7 font-semibold text-white">Découverte</h3>
			<p class="mt-4 flex items-baseline gap-x-2">
				<span class="text-5xl font-semibold tracking-tight text-white">Gratuit</span>
			</p>
			<p class="mt-6 text-base/7 text-gray-300">L'essentiel pour faire vos premiers pas dans la gestion de budget.</p>
			<ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-300 sm:mt-10">
				<li class="flex gap-x-3">
					<svg viewBox="0 0 20 20" fill="currentColor" class="h-6 w-5 flex-none text-gray-400"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" /></svg>
					1 compte bancaire synchronisé
				</li>
				<li class="flex gap-x-3">
					<svg viewBox="0 0 20 20" fill="currentColor" class="h-6 w-5 flex-none text-gray-400"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" /></svg>
			...
			<RouterLink to="inscription" aria-describedby="plan-gratuit" class="mt-8 w-full px-3.5 py-2.5 rounded-md font-semibold text-white flex items-center justify-center transition-all duration-300 bg-linear-to-r from-principale to-secondaire hover:shadow-[0_0_15px_#9034b080,0_0_15px_#096cfd80] cursor-pointer">Créer un compte gratuit</RouterLink>
		</div>

		<!-- plan essentiel -->
		<div class="rounded-xl bg-white/5 p-8 ring-2 ring-secondaire xl:p-10 relative">
			<div class="absolute -top-3 left-1/2 -translate-x-1/2 rounded-lg bg-secondaire px-4 py-1 text-xs font-semibold text-white">Le plus populaire</div>

			<h3 id="tier-essential" class="text-base/7 font-semibold text-secondaire">Essentiel</h3>
			<p class="mt-4 flex items-baseline gap-x-2">
				<span class="text-5xl font-semibold tracking-tight text-white">9$</span>
				<span class="text-base text-gray-400">/mois</span>
			</p>
			<p class="mt-6 text-base/7 text-gray-300">Le choix préféré pour reprendre le contrôle de vos finances au quotidien.</p>
			<ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-300 sm:mt-10">
				<li class="flex gap-x-3">
					<svg viewBox="0 0 20 20" fill="currentColor" class="h-6 w-5 flex-none text-secondaire"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" /></svg>
					Jusqu'à 5 banques synchronisées
				</li>
				<li class="flex gap-x-3">
					<svg viewBox="0 0 20 20" fill="currentColor" class="h-6 w-5 flex-none text-secondaire"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" /></svg>
			...
			<RouterLink to="inscription" aria-describedby="plan-essentiel" class="mt-8 w-full px-3.5 py-2.5 rounded-md font-semibold text-white flex items-center justify-center transition-all duration-300 bg-linear-to-r from-principale to-secondaire hover:shadow-[0_0_15px_#9034b080,0_0_15px_#096cfd80] cursor-pointer">Créer un compte</RouterLink>
		</div>

		<!-- plan premium-->
		<div class="rounded-xl p-8 ring-1 ring-white/10 xl:p-10 hover:bg-white/5 transition-colors">
			<h3 id="tier-premium" class="text-base/7 font-semibold text-white">Premium</h3>
			<p class="mt-4 flex items-baseline gap-x-2">
				<span class="text-5xl font-semibold tracking-tight text-white">29$</span>
				<span class="text-base text-gray-400">/mois</span>
			</p>
			<p class="mt-6 text-base/7 text-gray-300">Des outils avancés pour les investisseurs et la gestion de patrimoine.</p>
			<ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-300 sm:mt-10">
				<li class="flex gap-x-3">
					<svg viewBox="0 0 20 20" fill="currentColor" class="h-6 w-5 flex-none text-gray-400"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" /></svg>
					Comptes et banques illimités
				</li>
				<li class="flex gap-x-3">
					<svg viewBox="0 0 20 20" fill="currentColor" class="h-6 w-5 flex-none text-gray-400"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" /></svg>
					Suivi Bourse, Crypto & Immo
				</li>
				<li class="flex gap-x-3">
					<svg viewBox="0 0 20 20" fill="currentColor" class="h-6 w-5 flex-none text-gray-400"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" /></svg>
			...
			<RouterLink to="inscription" aria-describedby="plan-premium" class="mt-8 w-full px-3.5 py-2.5 rounded-md font-semibold text-white flex items-center justify-center transition-all duration-300 bg-linear-to-r from-principale to-secondaire hover:shadow-[0_0_15px_#9034b080,0_0_15px_#096cfd80] cursor-pointer">Créer un compte</RouterLink>
		</div>
	</div>

	<div v-if="!userConnecte" class="bg-linear-to-r from-principale to-secondaire pb-30 pt-14 px-4 text-sm/6">
		<div class="mx-auto pt-14 max-w-4xl text-center">
			...
			<div class="bg-card p-8 rounded-2xl shadow-xl border border-white/5 w-full max-w-md flex flex-col gap-6">
				...
				<div class="flex flex-col gap-4 z-50">
					...
					<div class="flex gap-2">
						...
						<button type="button" @click="togglePasswordShow" class="px-4 w-fit rounded-md bg-principale hover:opacity-80">
					...
					<div class="flex flex-col gap-4 mt-2 z-50">
						<!-- Bouton dégradé-->
						<button @click="connexion" class="w-full px-3.5 py-2.5 rounded-md font-semibold text-white flex items-center justify-center transition-all duration-300 bg-linear-to-r from-principale to-secondaire hover:shadow-[0_0_15px_#9034b080,0_0_15px_#096cfd80] cursor-pointer">Se connecter</button>
					</div>
				</div>
