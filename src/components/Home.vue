<template>
        ...
        <div class="w-full flex-col md:flex-row flex py-10 sm:py-34 lg:py-20">
          ...
          >
            <div class="hidden sm:mb-8 sm:flex">
              <div
                class="relative rounded-full px-3 py-1 text-sm/6 text-gray-400 ring-1 ring-white/10"
              >
            ...
            <div>
              ...
              <div
                v-if="!userConnecte"
                class="mt-10 flex items-center md:justify-start justify-center gap-x-6"
              >
                <RouterLink
                  to="connexion"
                ...
                <RouterLink
                  to="inscription"
                  class="text-md font-semibold text-white hover:text-secondaire"
                  >S'inscrire <span aria-hidden="true">→</span></RouterLink
                >
              </div>
            </div>
          </div>
          ...
          <div class="flex w-full justify-center">
            <img
              ...
              alt="photo de l'application mobile Stratos "
  ...
  <div class="bg-linear-to-r from-principale to-secondaire pb-30 pt-26 px-4">
    <div class="mx-auto">
      ...
      <p
        class="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-200 sm:text-xl/8"
      >
      ...
      <div class="grid lg:grid-cols-3 md:grid-cols-2 mx-auto">
        ...
        >
          ...
          <p
            class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed"
          >
            ...
            <g mask="url(#a)">
              ...
              >
                ...
                <path
                  ...
                  d="m303.227 284.952-69.785-69.785M206.773 241.834l26.668-26.668"
                  data-original="#000000"
                />
              </g>
            </g>
        ...
        >
          ...
          <p
            class="text-gray-200 group-hover:text-gray-600 text-md leading-relaxed"
          >
  ...
  <div
    class="isolate mx-auto my-24 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3 sm:mt-20"
  >
    <!-- plan découverte -->
    <div
      class="rounded-xl p-8 ring-1 ring-white/10 xl:p-10 hover:bg-white/5 transition-colors"
    >
    ...
    <!-- plan essentiel -->
    <div
      class="rounded-xl bg-white/5 p-8 ring-2 ring-secondaire xl:p-10 relative"
    >
      <div
      ...
      <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-300 sm:mt-10">
        <li class="flex gap-x-3">
          <svg
            viewBox="0 0 20 20"
            fill="currentColor"
            class="h-6 w-5 flex-none text-secondaire"
          >
            <path
              fill-rule="evenodd"
              d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z"
      ...
      <RouterLink
        to="inscription"
        aria-describedby="plan-essentiel"
        class="mt-8 w-full px-3.5 py-2.5 rounded-md font-semibold text-white flex items-center justify-center transition-all duration-300 bg-linear-to-r from-principale to-secondaire hover:shadow-[0_0_15px_#9034b080,0_0_15px_#096cfd80] cursor-pointer"
  ...
  <div
    v-if="!userConnecte"
    class="bg-linear-to-r from-principale to-secondaire pb-30 pt-14 px-4 text-sm/6"
  >
    <div class="mx-auto pt-14 max-w-4xl text-center">
    ...
    <div
      class="flex flex-col gap-8 md:flex-row items-center mt-20 justify-around m-auto w-full"
    >
      <!-- card-->
      <div
  ...
  <div class="">
    ...
    >
      <div
        ...
        "
        class="mx-auto aspect-1155/678 w-288.75 bg-linear-to-tr from-principale to-secondaire opacity-20"
      ></div>
    </div>
  </div>
</template>
