      ...
      <div class="max-w-2xl py-32 sm:py-48 lg:py-56">
        <div class="hidden sm:mb-8 sm:flex">
          <div class="relative rounded-full px-3 py-1 text-sm/6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
            Solutions financières complètes pour tous les besoins</div>
        </div>
        <div class="">
          <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Vos finances en un seul
            endroit</h1>
          <p class="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">Le savoir, c'est le pouvoir. Vous
            devez connaître vos finances pour les maîtriser. Wallet rassemble tout votre argent dans une seule
            application, sous votre contrôle, où que vous soyez.</p>
          <div v-if="!userConnecte" class="mt-10 flex items-center gap-x-6">
            <a href="/connexion"
              class="rounded-md bg-secondaire px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-secondaire focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondaire">Se
              connecter</a>
            <a href="/inscription" class="text-sm/6 font-semibold text-white">S'inscrire <span
  ...
  <div class="bg-linear-to-r from-principale to-secondaire pb-30 pt-26 px-4">
    <div class="mx-auto">
      <div class="mx-auto max-w-4xl text-center">
        <h2 class="text-md font-semibold text-white">Nos outils</h2>
        <p class="mt-2 text-5xl font-semibold tracking-tight text-balance text-white sm:text-6xl">Tout ce dont vous avez
          besoin pour gérer vos finances</p>
      </div>
      <p class="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-200 sm:text-xl/8">Stratos
        fournit tous les outils nécessaires pour prendre le contrôle de votre argent et atteindre vos objectifs
        financiers.</p>
      <div class="grid lg:grid-cols-3 md:grid-cols-2 mx-auto">
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Créez des budgets flexibles qui
            s'adaptent à votre mode de vie, facilitant le suivi de vos objectifs.</p>
        </div>
        ...
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Catégorisez et suivez
            automatiquement vos dépenses avec des analyses détaillées et des tendances de dépenses.</p>
        </div>
        ...
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Ne manquez plus jamais une facture
            grâce aux paiements programmés et aux rappels intelligents pour les dépenses à venir.</p>
        </div>
        ...
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Comprenez vos revenus et dépenses
            grâce à des rapports visuels et des analyses prédictives.</p>
        </div>
        ...
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-700 text-md leading-relaxed">Connectez-vous en toute sécurité à
            plus de 15 000 banques dans le monde pour une synchronisation automatique des transactions et des mises à
            jour de solde en temps réel.</p>
        </div>
        ...
        <div
          ...
          <p class="text-gray-200 group-hover:text-gray-600 text-md leading-relaxed">Connectez vos données à Excel, aux
            assistants IA ou créez des intégrations personnalisées avec MCP et l'API REST.</p>
        </div>
      </div>
    </div>
  </div>

  <div v-if="!userConnecte" class="bg-background text-sm/6 flex items-center mt-20 justify-around w-[70%] m-auto">
    <!-- card-->
    <div class="bg-card p-8 rounded-2xl shadow-xl border border-white/5 w-full max-w-md flex flex-col gap-6">
      ...
      <div class="flex flex-col gap-4 mt-2">
        ...
        <button @click="connexion"
          class="w-full px-3.5 py-2.5 rounded-md font-semibold text-white flex items-center justify-center transition-all duration-300 bg-gradient-to-r from-principale to-secondaire hover:shadow-[0_0_15px_#9034b080,0_0_15px_#096cfd80]">Se
          connecter</button>

        <div class="flex gap-3">
          <!-- bouton couelur principale -->
          <button
            class="w-full px-3.5 py-2.5 rounded-md font-semibold text-white flex items-center justify-center transition-all duration-300 bg-principale hover:opacity-80 hover:shadow-[0_0_15px_#9034b066]">Action
            1</button>

          <!-- Bouton couleur secondaire -->
          <button
            class="w-full px-3.5 py-2.5 rounded-md font-semibold text-white flex items-center justify-center transition-all duration-300 bg-secondaire hover:opacity-80 hover:shadow-[0_0_15px_#096cfd66]">Action
            2</button>
        </div>
      </div>
    </div>
