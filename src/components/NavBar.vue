  ...
  <header class="inset-x-0 top-0 z-50">
    ...
    >
      <RouterLink to="/" class="text-base/7 font-semibold text-white z-99">
        <div class="flex lg:flex-1">
          <div href="#" class="-m-1.5 p-1.5">
            ...
            <img
              src="../assets/images/statos-logo-horizontal.png"
              alt="Stratos logo"
              class="h-8 w-auto"
            />
          </div>
      ...
      <div v-if="!userConnecte" class="hidden lg:flex lg:gap-x-12">
        ...
        <RouterLink
          to="inscription"
          class="text-base/7 font-semibold text-white z-99 hover:cursor-pointer hover:text-secondaire"
          >S'inscrire
        </RouterLink>
      </div>
          ...
          >
            <div class="flex px-3 items-center justify-between">
              <RouterLink to="/" class="-m-1.5 p-1.5">
                <span class="sr-only">Stratos</span>
                <img
                  src="../assets/images/statos-logo-icon.png"
                  alt="Stratos logo"
                  class="h-8 w-auto"
                />
              </RouterLink>
              ...
              <div class="-my-6 divide-y divide-white/10">
                <div class="">
                  ...
                  <div v-else class="text-white space-y-2 py-6">
                    ...
                    <a
                      href="profil"
                      class="block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5"
                      >Profil</a
                    >
                    <a
                      href="budget"
