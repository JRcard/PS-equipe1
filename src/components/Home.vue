      ...
      <div class="max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="">
          ...
          <div v-if="!userConnecte" class="mt-10 flex items-center gap-x-6">
            <a href="/connexion" class="rounded-md bg-secondaire px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-secondaire focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondaire">Se connecter</a>
